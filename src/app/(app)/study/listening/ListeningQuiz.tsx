    ...
    <div className="relative max-w-lg mx-auto px-4 py-6 space-y-6">
      ...
      <div className="flex justify-center py-4">
        <button
          ...
          className={cn(
            "flex h-28 w-28 items-center justify-center rounded-full border-4 border-primary bg-primary/10 text-5xl shadow-[0_4px_0_0_var(--primary-deep)] transition-all active:translate-y-[3px] active:shadow-none",
